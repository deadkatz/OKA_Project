...
public class OrbitCameraTEST : MonoBehaviour
{
	private Transform target;
	private string stringTarget;
	
	public Transform biuroTarget;
	public Transform mebelTarget;
	public Transform lampaTarget;
	public Transform designTarget;
	public Transform diamondTarget;
	public Transform krzesloTarget;
	
	public GameObject biuroEnv;
	public GameObject mebelEnv;
	public GameObject lampaEnv;
	public GameObject designEnv;
	public GameObject diamondEnv;
	public GameObject krzesloEnv;
